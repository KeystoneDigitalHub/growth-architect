...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center section-padding pt-28 sm:pt-32">
      {/* Ambient glow */}
      ...
      <div className="relative max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-xl mb-10 leading-relaxed">
            We identify growth bottlenecks and build structured systems combining creative, advertising precision, and automation workflows.
          </p>
